Q1. Find the largest sum of a contiguous subarray of an array. Example: 1,2,-1,-3,4,6 will have the max as 10. For 1, 4, -8,  answer is 5.

Q2. Sanitize numbers after reading each line that contains space-separated sequence of numbers. Remove all duplicates ,order them and output them.
